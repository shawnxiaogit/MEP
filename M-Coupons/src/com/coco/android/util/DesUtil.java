...
public class DesUtil {
	 ...
	 */
	private  String strDefaultKey = "12345678";
...
//		86512525
		DesUtil desUtil = new DesUtil("3836353132353235");
		System.out.println("hex_key:"+DigitalTrans.stringToHexString(desUtil.strDefaultKey));
		String hex_data = "";
		System.out.println("hex_data:"+hex_data);
//		String str_data = DigitalTrans.stringToHexString(hex_data);
//		System.out.println("str_data:"+str_data);
////		DigitalTrans.
////		System.out.println("str_data:"+str_data);
//		String des_str=desUtil.Decode(str_data);
//		System.out.println("des_str:"+des_str);
//		for(int i=0;i<des_str.length();i++){
//			System.out.println(des_str.getBytes()[i]);
//		}
//		System.out.println("des_str:"+DigitalTrans.hexStringToString(des_str, 2));
		String des_str=desUtil.Decode(hex_data);
		System.out.println("明文:"+des_str);
		System.out.println(DigitalTrans.stringToHexString(des_str));

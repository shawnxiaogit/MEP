package com.coco.android.wheelview;
...
//		showlunarTimePicker();
		...
		btn_solar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				btn_solar.setTextColor(view.getResources().getColor(R.color.white));
				btn_lunar.setBackgroundResource(R.drawable.whtbtn);
				btn_lunar.setTextColor(view.getResources().getColor(R.color.orange));
				initDateTimePicker(year, month, day);
			}
		...
		btn_lunar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				btn_lunar.setTextColor(view.getResources().getColor(R.color.white));
				btn_solar.setBackgroundResource(R.drawable.whtbtn);
				btn_solar.setTextColor(view.getResources().getColor(R.color.orange));
				showlunarTimePicker();
			}
	...
	public String getHourMin(){
		...
		String info = getHours()+":" +getMin();
		SimpleDateFormat format3  = new SimpleDateFormat("HH:mm");
		
		try {
			info = format3.format(format3.parse(info));
